...
public class ValidarCpfTitular extends AbstractValidator {

	@Override
	public String validar(EntidadeDominio entidade) {
		Cartao cartao = (Cartao) entidade;
		mensagem = new StringBuilder();
		mensagem.append(validarCpfTitular(cartao.getCpfTitular()));
		return mensagem.toString();
	}

	private String validarCpfTitular(String cpf) {
